...
</html>`;R.get("/",e=>e.html(Ra()));var Z=class extends Error{constructor(e,t){super(e,t),this.name="RequestError"}},Ca=e=>e instanceof Z?e:new Z(e.message,{cause:e}),Da=global.Request,Pe=class extends Da{constructor(t,a){var r;typeof t=="object"&&ye in t&&(t=t[ye]()),typeof((r=a==null?void 0:a.body)==null?void 0:r.getReader)<"u"&&(a.duplex??(a.duplex="half")),super(t,a)}},Ta=e=>{const t=[],a=e.rawHeaders;for(let r=0;r<a.length;r+=2){const{[r]:s,[r+1]:n}=a;s.charCodeAt(0)!==58&&t.push([s,n])}return new Headers(t)},Ht=Symbol("wrapBodyStream"),La=(e,t,a,r,s)=>{const n={method:e,headers:a,signal:s.signal};if(e==="TRACE"){n.method="GET";const i=new Pe(t,n);return Object.defineProperty(i,"method",{get(){return"TRACE"}}),i}if(!(e==="GET"||e==="HEAD"))if("rawBody"in r&&r.rawBody instanceof Buffer)n.body=new ReadableStream({start(i){i.enqueue(r.rawBody),i.close()}});else if(r[Ht]){let i;n.body=new ReadableStream({async pull(l){try{i||(i=ct.toWeb(r).getReader());const{done:c,value:d}=await i.read();c?l.close():l.enqueue(d)}catch(c){l.error(c)}}})}else n.body=ct.toWeb(r);return new Pe(t,n)},ye=Symbol("getRequestCache"),Xe=Symbol("requestCache"),Ge=Symbol("incomingKey"),Ue=Symbol("urlKey"),Ze=Symbol("headersKey"),U=Symbol("abortControllerKey"),Oa=Symbol("getAbortController"),Qe={get method(){return this[Ge].method||"GET"},get url(){return this[Ue]},get headers(){return this[Ze]||(this[Ze]=Ta(this[Ge]))},[Oa](){return this[ye](),this[U]},[ye](){return this[U]||(this[U]=new AbortController),this[Xe]||(this[Xe]=La(this.method,this[Ue],this.headers,this[Ge],this[U]))}};["body","bodyUsed","cache","credentials","destination","integrity","mode","redirect","referrer","referrerPolicy","signal","keepalive"].forEach(e=>{Object.defineProperty(Qe,e,{get(){return this[ye]()[e]}})});["arrayBuffer","blob","clone","formData","json","text"].forEach(e=>{Object.defineProperty(Qe,e,{value:function(){return this[ye]()[e]()}})});Object.setPrototypeOf(Qe,Pe.prototype);var Ia=(e,t)=>{const a=Object.create(Qe);a[Ge]=e;const r=e.url||"";if(r[0]!=="/"&&(r.startsWith("http://")||r.startsWith("https://"))){if(e instanceof Fe)throw new Z("Absolute URL for :path is not allowed in HTTP/2");try{const l=new URL(r);a[Ue]=l.href}catch(l){throw new Z("Invalid absolute URL",{cause:l})}return a}const s=(e instanceof Fe?e.authority:e.headers.host)||t;if(!s)throw new Z("Missing host header");let n;if(e instanceof Fe){if(n=e.scheme,!(n==="http"||n==="https"))throw new Z("Unsupported scheme")}else n=e.socket&&e.socket.encrypted?"https":"http";const i=new URL(`${n}://${s}${r}`);if(i.hostname.length!==s.length&&i.hostname!==s.replace(/:\d+$/,""))throw new Z("Invalid host header");return a[Ue]=i.href,a},Be=Symbol("responseCache"),ue=Symbol("getResponseCache"),ee=Symbol("cache"),st=global.Response,Le,F,ve,Oe=(ve=class{constructor(t,a){g(this,Le);g(this,F);let r;if(h(this,Le,t),a instanceof ve){const s=a[Be];if(s){h(this,F,s),this[ue]();return}else h(this,F,o(a,F)),r=new Headers(o(a,F).headers)}else h(this,F,a);(typeof t=="string"||typeof(t==null?void 0:t.getReader)<"u"||t instanceof Blob||t instanceof Uint8Array)&&(r||(r=(a==null?void 0:a.headers)||{"content-type":"text/plain; charset=UTF-8"}),this[ee]=[(a==null?void 0:a.status)||200,t,r])}[ue](){return delete this[ee],this[Be]||(this[Be]=new st(o(this,Le),o(this,F)))}get headers(){const t=this[ee];return t?(t[2]instanceof Headers||(t[2]=new Headers(t[2])),t[2]):this[ue]().headers}get status(){var t;return((t=this[ee])==null?void 0:t[0])??this[ue]().status}get ok(){const t=this.status;return t>=200&&t<300}},Le=new WeakMap,F=new WeakMap,ve);["body","bodyUsed","redirected","statusText","trailers","type","url"].forEach(e=>{Object.defineProperty(Oe.prototype,e,{get(){return this[ue]()[e]}})});["arrayBuffer","blob","clone","formData","json","text"].forEach(e=>{Object.defineProperty(Oe.prototype,e,{value:function(){return this[ue]()[e]()}})});Object.setPrototypeOf(Oe,st);Object.setPrototypeOf(Oe.prototype,st.prototype);async function Ha(e){return Promise.race([e,Promise.resolve().then(()=>Promise.resolve(void 0))])}function Mt(e,t,a){const r=l=>{e.cancel(l).catch(()=>{})};return t.on("close",r),t.on("error",r),(a??e.read()).then(i,s),e.closed.finally(()=>{t.off("close",r),t.off("error",r)});function s(l){l&&t.destroy(l)}function n(){e.read().then(i,s)}function i({done:l,value:c}){try{if(l)t.end();else if(!t.write(c))t.once("drain",n);else return e.read().then(i,s)}catch(d){s(d)}}}function Ma(e,t){if(e.locked)throw new TypeError("ReadableStream is locked.");return t.destroyed?void 0:Mt(e.getReader(),t)}var Bt=e=>{const t={};e instanceof Headers||(e=new Headers(e??void 0));const a=[];for(const[r,s]of e)r==="set-cookie"?a.push(s):t[r]=s;return a.length>0&&(t["set-cookie"]=a),t["content-type"]??(t["content-type"]="text/plain; charset=UTF-8"),t},Ba="x-hono-already-sent";typeof global.crypto>"u"&&(global.crypto=zt);var nt=Symbol("outgoingEnded"),Fa=()=>new Response(null,{status:400}),Ft=e=>new Response(null,{status:e instanceof Error&&(e.name==="TimeoutError"||e.constructor.name==="TimeoutError")?504:500}),tt=(e,t)=>{const a=e instanceof Error?e:new Error("unknown error",{cause:e});a.code==="ERR_STREAM_PREMATURE_CLOSE"?console.info("The user aborted a request."):(console.error(e),t.headersSent||t.writeHead(500,{"Content-Type":"text/plain"}),t.end(`Error: ${a.message}`),t.destroy(a))},Nt=e=>{"flushHeaders"in e&&e.writable&&e.flushHeaders()},qt=async(e,t)=>{var n,i;let[a,r,s]=e[ee];s instanceof Headers&&(s=Bt(s)),typeof r=="string"?s["Content-Length"]=Buffer.byteLength(r):r instanceof Uint8Array?s["Content-Length"]=r.byteLength:r instanceof Blob&&(s["Content-Length"]=r.size),t.writeHead(a,s),typeof r=="string"||r instanceof Uint8Array?t.end(r):r instanceof Blob?t.end(new Uint8Array(await r.arrayBuffer())):(Nt(t),await((n=Ma(r,t))==null?void 0:n.catch(l=>tt(l,t)))),(i=t[nt])==null||i.call(t)},Na=e=>typeof e.then=="function",qa=async(e,t,a={})=>{var s;if(Na(e))if(a.errorHandler)try{e=await e}catch(n){const i=await a.errorHandler(n);if(!i)return;e=i}else e=await e.catch(Ft);if(ee in e)return qt(e,t);const r=Bt(e.headers);if(e.body){const n=e.body.getReader(),i=[];let l=!1,c;if(r["transfer-encoding"]!=="chunked"){let d=2;for(let u=0;u<d;u++){c||(c=n.read());const f=await Ha(c).catch(m=>{console.error(m),l=!0});if(!f){if(u===1){await new Promise(m=>setTimeout(m)),d=3;continue}break}if(c=void 0,f.value&&i.push(f.value),f.done){l=!0;break}}l&&!("content-length"in r)&&(r["content-length"]=i.reduce((u,f)=>u+f.length,0))}t.writeHead(e.status,r),i.forEach(d=>{t.write(d)}),l?t.end():(i.length===0&&Nt(t),await Mt(n,t,c))}else r[Ba]||(t.writeHead(e.status,r),t.end());(s=t[nt])==null||s.call(t)},$a=(e,t={})=>{const a=t.autoCleanupIncoming??!0;return t.overrideGlobalObjects!==!1&&global.Request!==Pe&&(Object.defineProperty(global,"Request",{value:Pe}),Object.defineProperty(global,"Response",{value:Oe})),async(r,s)=>{let n,i;try{i=Ia(r,t.hostname);let l=!a||r.method==="GET"||r.method==="HEAD";if(l||(r[Ht]=!0,r.on("end",()=>{l=!0}),r instanceof Fe&&(s[nt]=()=>{l||setTimeout(()=>{l||setTimeout(()=>{r.destroy(),s.destroy()})})})),s.on("close",()=>{i[U]&&(r.errored?i[U].abort(r.errored.toString()):s.writableFinished||i[U].abort("Client connection prematurely closed.")),l||setTimeout(()=>{l||setTimeout(()=>{r.destroy()})})}),n=e(i,{incoming:r,outgoing:s}),ee in n)return qt(n,s)}catch(l){if(n)return tt(l,s);if(t.errorHandler){if(n=await t.errorHandler(i?l:Ca(l)),!n)return}else i?n=Ft(l):n=Fa()}try{return await qa(n,s,t)}catch(l){return tt(l,s)}}},Ga=e=>$a(e.fetch);const at=new It,Wa=Object.assign({"/index.tsx":R});let $t=!1;for(const[,e]of Object.entries(Wa))e&&(at.all("*",t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),at.notFound(t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),$t=!0);if(!$t)throw new Error("Can't import modules from ['/index.tsx']");const Ka=Ga(at);export{Ka as default};
